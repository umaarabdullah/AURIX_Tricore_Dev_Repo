...
Libraries/iLLD/TC37A/Tricore/Stm/Std/%.src: ../Libraries/iLLD/TC37A/Tricore/Stm/Std/%.c Libraries/iLLD/TC37A/Tricore/Stm/Std/subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/Users/Umaar/Documents/GitHub/AURIX_Tricore_Dev_Repo/Assembly_C_Code_1_KIT_TC375_LK/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<" && \
