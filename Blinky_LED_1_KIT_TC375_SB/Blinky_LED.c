...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define LED         &MODULE_P13, 2                                           /* LED: Port, Pin index  */
#define LED1        &MODULE_P10, 2                                           /* LED: Port, Pin index  */
#define LED2        &MODULE_P13, 1                                           /* LED: Port, Pin index  */
#define WAIT_TIME_LED   1000                                                 /* Wait time constant in milliseconds   */
#define WAIT_TIME_LED1  1000
#define WAIT_TIME_LED2  100
...
void blinkLED(void)
{
    ...
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME_LED));
}

void blinkLED1(void)
{
    IfxPort_togglePin(LED1);                                                     /* Toggle the state of the LED      */
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME_LED1));
}

void blinkLED2(void)
{
    IfxPort_togglePin(LED2);                                                     /* Toggle the state of the LED      */
    waitTime(IfxStm_getTicksFromMilliseconds(BSP_DEFAULT_TIMER, WAIT_TIME_LED2));
}
