...
Libraries/Service/CpuGeneric/SysSe/Comm/%.src: ../Libraries/Service/CpuGeneric/SysSe/Comm/%.c Libraries/Service/CpuGeneric/SysSe/Comm/subdir.mk
	...
	cctc -cs --dep-file="$(basename $@).d" --misrac-version=2004 -D__CPU__=tc37x "-fC:/Users/Umaar/AURIX-v1.9.0-workspace/BOT_CONTROL/Debug/TASKING_C_C___Compiler-Include_paths.opt" --iso=99 --c++14 --language=+volatile --exceptions --anachronisms --fp-model=3 -O0 --tradeoff=4 --compact-max-size=200 -g -Wc-w544 -Wc-w557 -Ctc37x -Y0 -N0 -Z0 -o "$@" "$<" && \
