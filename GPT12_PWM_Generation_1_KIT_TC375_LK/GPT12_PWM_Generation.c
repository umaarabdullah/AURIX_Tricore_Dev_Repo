...
/*    x/100 ms    */
#define firstUpTime     10000
#define secondUpTime    20000
#define thirdUpTime     30000
#define fourthUpTime    50000

uint16 myUpTime = firstUpTime;
uint16 test = 1;
#define myDownTime      35000
...
//    if(test == 1)   // Must use ! condition otherwise doesn't work
//    {
//        test = 0;
//        if(myUpTime == firstUpTime){
//            myUpTime = secondUpTime;
//            IfxGpt12_T4_setTimerValue(&MODULE_GPT120, myUpTime);
//        }
//        else if(myUpTime == secondUpTime){
//            myUpTime = thirdUpTime;
//            IfxGpt12_T4_setTimerValue(&MODULE_GPT120, myUpTime);
//        }
//        else if(myUpTime == thirdUpTime){
//            myUpTime = fourthUpTime;
//            IfxGpt12_T4_setTimerValue(&MODULE_GPT120, myUpTime);
//        }
//        else if(myUpTime == fourthUpTime){
//            myUpTime = firstUpTime;
//            IfxGpt12_T4_setTimerValue(&MODULE_GPT120, myUpTime);
//        }
//    }
//    else{
...
void initGpt12PWM(void)
{
    ...
    uint16 dutyUpTime = (fTimer * (1 - (PWM_DUTY_CYCLE / 100.0f))) / PWM_FREQUENCY;
    uint16 dutyDownTime = (fTimer * (PWM_DUTY_CYCLE / 100.0f)) / PWM_FREQUENCY;
...
//    IfxGpt12_T2_setTimerValue(&MODULE_GPT120, myDownTime); // divided by 100 and resultant is in ms
...
//    IfxGpt12_T4_setTimerValue(&MODULE_GPT120, myUpTime);
    ...
    IfxPort_setPinModeOutput(TEST_LED, IfxPort_OutputMode_pushPull, IfxPort_OutputIdx_general);
