...
//    IfxStdIf_DPipe_print(&g_ascStandardInterface, "\n\r Extra ticks : %llu \n\r",extra_ticks);
//    IfxStdIf_DPipe_print(&g_ascStandardInterface, "\n\r Extra time : %llu us\n\r",extra_time_us);
//    IfxStdIf_DPipe_print(&g_ascStandardInterface, "\n\r Inverse Clock Period : %llu us\n\r",inverse_clock_period_us);
...
//    } IfxStm_Comparator;
    /* IfxStm_Comparator_0 is compartor 0 as known from this structure that's why using IfxStm_Comparator_0*/
